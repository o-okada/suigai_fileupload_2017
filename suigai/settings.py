"""
Django settings for suigai project.
...
SECRET_KEY = ')5vq-8@-iq#bb(+=n!9j@7@4(1dh&y3^z5*inqyif^(_hgu9+-'
...
WSGI_APPLICATION = 'suigai.wsgi.application'


# Database
# https://docs.djangoproject.com/en/1.10/ref/settings/#databases

# MODIFY BEGIN FRICS 2017/03/27
DATABASES = {
    'default': {
...
LOGGING = {
    ...
    'loggers': {  # どんなloggerがあるかを設定する
        'file_upload': {  # commandという名前のloggerを定義
